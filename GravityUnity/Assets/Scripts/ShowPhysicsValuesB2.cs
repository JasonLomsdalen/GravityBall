...
public class ShowPhysicsValuesB2 : MonoBehaviour
{
    Vector3 startPos;
    Vector3 lastPos;
    Rigidbody rb;
    ...
    void Start()
    {
        ...
        forceApplied = GameObject.Find("CanvasB2/B2ForceValue").GetComponent<Text>();
        angleApplied = GameObject.Find("CanvasB2/B2AngleValue").GetComponent<Text>();
        distanceTraveled = GameObject.Find("CanvasB2/B2DistanceValue").GetComponent<Text>();

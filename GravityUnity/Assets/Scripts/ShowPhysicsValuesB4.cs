...
public class ShowPhysicsValuesB4 : MonoBehaviour
{
    Vector3 startPos;
    Vector3 lastPos;
    Rigidbody rb;
    ...
    void Start()
    {
        ...
        forceApplied = GameObject.Find("CanvasB4/B4ForceValue").GetComponent<Text>();
        angleApplied = GameObject.Find("CanvasB4/B4AngleValue").GetComponent<Text>();
        distanceTraveled = GameObject.Find("CanvasB4/B4DistanceValue").GetComponent<Text>();

...
public class ShowPhysicsValuesB5 : MonoBehaviour
{
    Vector3 startPos;
    Vector3 lastPos;
    Rigidbody rb;
    ...
    void Start()
    {
        ...
        forceApplied = GameObject.Find("CanvasB5/B5ForceValue").GetComponent<Text>();
        angleApplied = GameObject.Find("CanvasB5/B5AngleValue").GetComponent<Text>();
        distanceTraveled = GameObject.Find("CanvasB5/B5DistanceValue").GetComponent<Text>();

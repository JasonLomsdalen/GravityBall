...
public class ShowPhysicsValuesB3 : MonoBehaviour
{
    Vector3 startPos;
    Vector3 lastPos;
    Rigidbody rb;
    ...
    void Start()
    {
        ...
        forceApplied = GameObject.Find("CanvasB3/B3ForceValue").GetComponent<Text>();
        angleApplied = GameObject.Find("CanvasB3/B3AngleValue").GetComponent<Text>();
        distanceTraveled = GameObject.Find("CanvasB3/B3DistanceValue").GetComponent<Text>();
